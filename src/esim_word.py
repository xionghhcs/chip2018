...
def esim(embeddings,
    ...
    q1_embed = Dropout(0.3)(q1_embed)
    q2_embed = Dropout(0.3)(q2_embed)
    ...
    #
    # q_encoded_rep = Concatenate()(combine_list)
    # q_encoded_rep = BatchNormalization()(q_encoded_rep)
    # q_encoded_rep = Dropout(0.3)(q_encoded_rep)
    ...
    att_rep = Concatenate()([q1_att, q2_att, sub_att])
    att_rep = BatchNormalization(axis=-1)(att_rep)
    att_rep = Dropout(0.3)(att_rep)
    ...
    # Classifier
    # merged = Concatenate()([q1_compare, q2_compare])
    merged = Concatenate()([q_rep, att_rep])
...
config = {
    ...
    'batch_size': 256,
    'epochs': 40,
    'model_path': '../models/esim_word/kf{}.h5',
    'result_path': '../submit/esim_word_v1.csv',
    'log_file': '../log/esim_word_f1.csv'
}
...
def train():
    ...
    for t_idx, v_idx in kf.split(q1, q2, y):
        ...
        model_path = '../models/esim_word/kf_{}.h5'.format(split_id)
        ...
        # np.save('../prediction/esim_word/train_kf_{}.npy'.format(split_id), v_pred)
        #
        # # 保存在测试集上的结果
        # y_pred = model.predict(x=[q1_test, q2_test])
        # np.save('../prediction/esim_word/test_kf_{}.npy'.format(split_id), y_pred)
